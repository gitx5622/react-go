...
func CreateComment(c *gin.Context) {
	...
	commentCreated, err := comment.SaveComment(Config.DB)
	if err != nil {
...
func  GetComments(c *gin.Context) {
	...
	comments, err := comment.GetComments(Config.DB, pid)
	if err != nil {
...
func UpdateComment(c *gin.Context) {
	...
	//Check if the post exist
	origComment := entities.Comment{}
	err = Config.DB.Debug().Model(entities.Post{}).Where("id = ?", pid).Take(&origComment).Error
	if err != nil {
	...
	commentUpdated, err := comment.UpdateAComment(Config.DB)
	if err != nil {
		formattedError := utils.FormatError(err.Error())
		errList = formattedError
...
func DeleteComment(c *gin.Context) {
	...
	comment := entities.Comment{}
	err = Config.DB.Debug().Model(entities.Comment{}).Where("id = ?", cid).Take(&comment).Error
	if err != nil {
		errList["No_post"] = "No Post Found"
		c.JSON(http.StatusNotFound, gin.H{
			"status": http.StatusNotFound,
	...
	_, err = comment.DeleteAComment(Config.DB)
	if err != nil {
